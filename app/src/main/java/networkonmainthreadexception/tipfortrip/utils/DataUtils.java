package networkonmainthreadexception.tipfortrip.utils;
...
public class DataUtils {
    ...
    public static List<RouteItem> generateNews() {

        List<RouteItem> news = new ArrayList<>();
        news.add(new RouteItem(
